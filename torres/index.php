            ...
            <div class="bg-white p-8 rounded-2xl shadow-xl">
                ...
                <form action="index.php" method="POST">
                    <div class="mb-4">
                        ...
                        <input type="text" id="id-number" name="id-number" placeholder="Enter ID number" class="shadow border rounded-xl w-full py-3 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div class="mb-6">
                        <label for="password" class="block text-gray-700 text-sm font-bold mb-2">Password</label>
                        <input type="password" id="password" name="password" placeholder="Enter password" class="shadow border rounded-xl w-full py-3 px-4 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
